 ...
 *
 * The host check is deliberately platform-neutral. This site is built as a
 * static export for Firebase Hosting, where `*.web.app` and `*.firebaseapp.com`
 * are the throwaway hosts; the Vercel and Netlify entries are kept so the guard
 * still holds if it is ever built somewhere else.
 */
